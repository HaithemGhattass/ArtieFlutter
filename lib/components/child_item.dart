...
class ChildItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      final maxWidth = constraints.maxWidth.isFinite ? constraints.maxWidth.toDouble() : 200.0;
      final maxHeight = constraints.maxHeight.isFinite ? constraints.maxHeight.toDouble() : 200.0;
    
      return FutureBuilder<List>(
        future: _createShaderAndImage(
            asset!, mask!, maxWidth, maxHeight),
